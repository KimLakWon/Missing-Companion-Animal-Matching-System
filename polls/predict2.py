...
class Predictor():
    ...
    def __init__(self, path, node_name_path="polls/node_names.txt", show_tf_flag=False):
        if not show_tf_flag:
...
def main(m_path, i_path):
    #m_path = 'cat_recognition_train_master/' + m_path
...
def recog(img_url):
    import argparse
    return main("polls/baseline_model/optimized_net_best_acc.pb", img_url)
